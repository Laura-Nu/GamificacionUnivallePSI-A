  ...
  useEffect(() => {
    fetch('https://localhost:7103/api/Sanctions')
      ...
      .then((data) => {
        ...
        const filteredData = formattedData.filter((sanction) => sanction.status === 1 && sanction.type === "Achievement");
  ...
  return (
    <div>
      <div className="container">
        <div className="row">
          <div className="col-12">
            <h2 className="font-weight-bold">Logros</h2><br/>
            <a href='/CreateAchievement' className="btn btn-success mb-3 btnAdd">Añadir Logro</a>
            <table className="table table-responsive text-center mx-5">
              <thead>
                <tr>
                  <th>Nombre</th>
                  <th>Descripción</th>
                  <th>Puntos a añadir</th>
              ...
              <tbody>
                {sanctions.map((sanction) => (
                  <tr key={sanction.sanctionId}>
                    ...
                    <td>
                      <a href={`/UpdateAchievement/${sanction.sanctionId}`} className="btn btn-sm btn-warning">Editar</a>
      ...
      <Modal show={showDeleteModal} onHide={() => setShowDeleteModal(false)}>
        ...
        <Modal.Body>¿Estás seguro de que quieres eliminar este logro?</Modal.Body>
        <Modal.Footer>
