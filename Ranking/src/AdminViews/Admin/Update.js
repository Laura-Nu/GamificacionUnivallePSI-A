<<<<<<< HEAD:ranking_estv1.0/src/AdminViews/Admin/Update.js
...
function Update() {
  return (
    <div className="App bg-green">
      <h2> Actualizar Administradores</h2>
        ...
        <div className='row mx-5 p-5'>
          <form className='col-md-5 mx-5'>
            ...
            <div className="form-group">
              ...
              <DatePicker dateFormat="dd/MM/yyyy" className="form-control border-success border-3 rounded-4" />
            </div>
...
export default Update;
>>>>>>> d9636ecf7913d59cd514eb63c5cc84923d70a99b:Ranking/src/AdminViews/Admin/Update.js
