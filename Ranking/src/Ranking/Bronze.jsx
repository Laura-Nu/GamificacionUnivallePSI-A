...
function Bronze() {
  const [bronzeStudents, setBronzeStudents] = useState([]);
  ...
  useEffect(() => {
    fetch('https://localhost:7103/api/People')
      ...
      .then((data) => {
        const filteredBronzeStudents = data.filter((student) => {
          return student.role === 'Student' && ['Bronce I', 'Bronce II', 'Bronce III'].includes(student.student.rank);
        });
        const sortedData = filteredBronzeStudents.sort((a, b) => parseInt(b.student.score) - parseInt(a.student.score));
        setBronzeStudents(sortedData);
      })
      ...
      <div className="container">
        <div className="row">
          <div className="col-12">
            <h2 className="font-weight-bold">Ranking Bronce</h2>
            <div className="button-container">
              ...
              <a href="#" className="btn btn-bronze mb-3">Bronce</a>
            </div>
