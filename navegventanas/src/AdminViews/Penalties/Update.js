        ...
        <div className='row mx-5 p-5'>
          <form className='col-md-5 mx-5'>
            ...
            <div className="form-group">
              ...
              <input className="form-control border-success border-3 rounded-4" type="text" id="description" name="description" />
            </div>

            <div className="form-group">
              <label htmlFor="levels">Cantidad de puntos a descontar:</label>
              <input className="form-control border-success border-3 rounded-4" type="number" id="points" name="points" />
            </div>
